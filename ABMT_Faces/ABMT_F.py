...
img=Image.open("Faces/T1.JPG")
img_tr1=img.resize((imgwidth,imgheight))
img_tr1=ImageTk.PhotoImage(img_tr1)

img=Image.open("Faces/1.JPG")
imgt1=img.resize((imgwidth,imgheight))
imgt1=ImageTk.PhotoImage(imgt1)

img=Image.open("Faces/2.JPG")
imgt2=img.resize((imgwidth,imgheight))
imgt2=ImageTk.PhotoImage(imgt2)

img=Image.open("Faces/3.JPG")
imgt3=img.resize((imgwidth,imgheight))
imgt3=ImageTk.PhotoImage(imgt3)

img=Image.open("Faces/4.JPG")
imgt4=img.resize((imgwidth,imgheight))
imgt4=ImageTk.PhotoImage(imgt4)

img=Image.open("Faces/5.JPG")
imgt5=img.resize((imgwidth,imgheight))
imgt5=ImageTk.PhotoImage(imgt5)

img=Image.open("Faces/6.JPG")
imgt6=img.resize((imgwidth,imgheight))
imgt6=ImageTk.PhotoImage(imgt6)

img=Image.open("Faces/7.JPG")
imgt7=img.resize((imgwidth,imgheight))
imgt7=ImageTk.PhotoImage(imgt7)

img=Image.open("Faces/8.JPG")
imgt8=img.resize((imgwidth,imgheight))
imgt8=ImageTk.PhotoImage(imgt8)

img=Image.open("Faces/9.JPG")
imgt9=img.resize((imgwidth,imgheight))
imgt9=ImageTk.PhotoImage(imgt9)

img=Image.open("Faces/10.JPG")
imgt10=img.resize((imgwidth,imgheight))
imgt10=ImageTk.PhotoImage(imgt10)

img=Image.open("Faces/11.JPG")
imgt11=img.resize((imgwidth,imgheight))
imgt11=ImageTk.PhotoImage(imgt11)

img=Image.open("Faces/12.JPG")
imgt12=img.resize((imgwidth,imgheight))
imgt12=ImageTk.PhotoImage(imgt12)

img=Image.open("Faces/13.JPG")
imgt13=img.resize((imgwidth,imgheight))
imgt13=ImageTk.PhotoImage(imgt13)

img=Image.open("Faces/14.JPG")
imgt14=img.resize((imgwidth,imgheight))
imgt14=ImageTk.PhotoImage(imgt14)

img=Image.open("Faces/15.JPG")
imgt15=img.resize((imgwidth,imgheight))
imgt15=ImageTk.PhotoImage(imgt15)

img=Image.open("Faces/16.JPG")
imgt16=img.resize((imgwidth,imgheight))
...
neut=[imgt2,imgt4,imgt6,imgt8,imgt10,imgt12,imgt14,imgt16]#neutral - Incongruent
neg=[imgt1,imgt3,imgt5,imgt7,imgt9,imgt11,imgt13,imgt15]#negative - congruent
poi=["Top","Bot"]#pointer
...
def training():
    ...
    def TrainingTrial():
        ...
        def plusshow():
            trnum=Label(top,text=str(count2_tr+1)+" Of 10",bg="black",fg="white")
        ...
        def imgshow():
            img.config(image=img_tr1)
            img.place(x=int((ws/2)-(imgwidth/2)),y=int((hs/2)-imgheight-(imgspace/2)))
            img2.config(image=img_tr1)
            img2.place(x=int((ws/2)-(imgwidth/2)),y=int((hs/2)+(imgspace/2)))
            top.after(500,prob)
...
Training_bot=Button(root,text="Training",width=25,height=3,command=training,bg="#CACAFF",font=("Arial",15,"bold"), relief=RIDGE)
start_bot=Button(root,text="Start Trial",width=25,height=3,command=start ,bg="#CACAFF",font=("Arial",15,"bold"), relief=RIDGE)
score_bot=Button(root,text="Show The Scores",width=25,height=3,command=scores,bg="#CACAFF",font=("Arial",15,"bold"), relief=RIDGE)
exit_bot=Button(root,text="EXIT Program",height=2,command=close,bg="#CACAFF",font=("Arial",15,"bold"), relief=RIDGE)
